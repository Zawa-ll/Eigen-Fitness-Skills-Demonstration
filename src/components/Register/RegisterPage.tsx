    ...
    return (
        <>
            ...
            <IonModal ref={modal} trigger='register-modal' onWillDismiss={(ev) => onWillDismiss(ev)}>
                ...
                {/* <IonContent>
                    <IonInput label="UserName" label-placement="floating" fill="solid" placeholder="Enter text"></IonInput>
                    <IonInput label="Password" label-placement="floating" fill="solid" placeholder="Enter text"></IonInput>
                    <IonButton color={'medium'} onClick={handleSubmit}>Submit</IonButton>
                </IonContent> */}
            </IonModal>
